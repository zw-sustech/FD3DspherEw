...
if numel(varargin{n})==1 | ~isnumeric(varargin{n})
   ...
   case {'phase_Vp','amplitude_Vp', ...
       ...
       varnm=varargin{n};
       fnm_prefix=['kernel_'];
   case {'phase_lambda_LM','amplitude_lambda_LM', ...
         'phase_mu_LM'    ,'amplitude_mu_LM'    , ...
         'phase_kappa_KM' ,'amplitude_kappa_KM'    , ...
         'phase_mu_KM'    ,'amplitude_mu_KM'    , ...
         }
       varnm=varargin{n};
       fnm_prefix=['kernel_'];
   case {'phase_Vph','amplitude_Vph', ...
         'phase_Vsh','amplitude_Vsh', ...
         'phase_Vpv','amplitude_Vpv', ...
         'phase_Vsv','amplitude_Vsv', ...
         'phase_eta','amplitude_eta', ...
         'phase_A'  ,'amplitude_A'  , ...
         'phase_C'  ,'amplitude_C'  , ...
         'phase_N'  ,'amplitude_N'  , ...
         'phase_L'  ,'amplitude_L'  , ...
